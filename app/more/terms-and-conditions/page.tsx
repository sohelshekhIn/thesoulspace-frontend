  ...
  return (
    <div className="w-[90vw] max-w-4xl p-2 md:p-10 mx-auto">
      ...
      <p>
        ...
        conditions. Do not continue to use thesoulspace if you do not agree to
      ...
      <h3 className="text-xl font-semibold mt-4">License</h3>

      <p>
        Unless otherwise stated, the soulspace and/or its licensors own the
        intellectual property rights for all material on thesoulspace. All
        intellectual property rights are reserved. You may access this from
        thesoulspace for your own personal use subject to restrictions set in
        these terms and conditions.
      </p>

      <ul className="list-disc pl-6 mt-2">
        <li>Republish material from thesoulspace</li>
        <li>Sell, rent, or sub-license material from thesoulspace</li>
        <li>Reproduce, duplicate, or copy material from thesoulspace</li>
        <li>Redistribute content from thesoulspace</li>
      </ul>

      <p>
        Parts of this website offer an opportunity for users to post and
        exchange opinions and information in certain areas of the website. the
        soulspace does not filter, edit, publish, or review Comments prior to
        their presence on the website. Comments do not reflect the views and
        opinions of the soulspace, its agents, and/or affiliates. Comments
        reflect the views and opinions of the person who posts their views and
        opinions. To the extent permitted by applicable laws, the soulspace
      ...
      <p>
        the soulspace reserves the right to monitor all Comments and to remove
        any Comments that can be considered inappropriate, offensive, or cause a
      ...
      <p>
        You hereby grant the soulspace a non-exclusive license to use,
      ...
      <p>
        ...
        the hyperlink compensates the absence of the soulspace; and (d) the link
      ...
      <p>
        ...
        e-mail to the soulspace. Please include your name, your organization
        name, contact information, as well as the URL of your site, a list of
        any URLs from which you intend to link to our Website, and a list of the
      ...
      <h3 className="text-xl font-semibold mt-4">iFrames</h3>
      ...
      <h3 className="text-xl font-semibold mt-4">Content Liability</h3>
      ...
      <h3 className="text-xl font-semibold mt-4">Reservation of Rights</h3>
