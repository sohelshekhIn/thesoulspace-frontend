  ...
  return (
    <nav className="w-full sticky py-2 px-5 lg:py-5 lg:px-14">
      <div className="flex flex-wrap items-center justify-between py-2 gap-6 md:py-4 md:gap-0 relative">
        <div className="z-20 flex justify-between md:px-0 lg:w-full">
          <input
            aria-hidden="true"
            type="checkbox"
            name="toggle_nav"
          ...
          />
          <a href="#home" aria-label="logo" className="z-30 md:w-1/2">
            <div aria-hidden="true" className="flex space-x-1">
              <div className="w-7/12 md:w-10/12 lg:w-7/12 2xl:w-5/12 ">
                <Image src={logo} alt="logo" />
              </div>
            </div>
          </a>
          <div className="relative flex items-center lg:hidden max-h-10 z-30">
            <label
              role="button"
              htmlFor="toggle_nav"
