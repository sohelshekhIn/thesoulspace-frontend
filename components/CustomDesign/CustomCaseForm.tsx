...
export default function CustomCaseForm() {
  ...
  return (
    <Formik
      ...
      validationSchema={Yup.object({
        ...
        phoneModel: Yup.string().required("Required").min(3),
          ...
          <div className="flex flex-col md:flex-row gap-5 md:gap-2 w-full">
            ...
            <div className="flex flex-col">
              ...
              <Field
                ...
                name="phoneModel"
                id="email"
                placeholder="Model of your Phone"
              />
              <p className="text-red-500 text-sm ">
                {/* @ts-ignore */}
                {errors.phoneModel && touched.phoneModel && errors.phoneModel}
              </p>
            </div>
          </div>
          <div className="flex flex-col">
